...
public class ContacturaController {
	...
	// lista todos os contatos - http://localhost:8088/contactura
	@GetMapping
	public List findAll(){
		return repository.findAll();
	}
	
	// lista contatos por ID - http://localhost:8088/contactura/{id}
	@GetMapping(value = "{id}")
	...
	//criar um contato http://localhost:8088/contactura
	@PostMapping
	...
	// Atualiza contatos por ID - http://localhost:8088/contactura/{id}
	@PutMapping(value = "{id}")
